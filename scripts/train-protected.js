...
async function main() {
    const outPath = path.join(__dirname, "../scratch/protected-content.txt");
    await ingestBook(outPath, { title: "Protected Numerology Vault (A. Danielsson & Sharita)", author: "Special Sources" });
}
