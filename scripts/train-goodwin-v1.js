...
async function main() {
    const goodwinFile = path.join(__dirname, "../goodwin.txt");
    await ingestBook(goodwinFile, { title: "Numerology The Complete Guide Vol 1", author: "Matthew Oliver Goodwin" });

    const vol3File = path.join(__dirname, "../Numerology The Complete Guide Vol 3.txt");
    await ingestBook(vol3File, { title: "Numerology The Complete Guide Vol 2 (Advanced)", author: "Matthew Oliver Goodwin" });
}
